...
import com.googlecode.gwtwebgl.utils.JsAny;
import com.googlecode.gwtwebgl.utils.JsMixinBase;

public class JsWebGLRenderingContext extends JsMixinBase implements WebGLRenderingContext {
  ...
  public final native JsArray<JsWebGLShader> getAttachedShaders(WebGLProgram program) /*-{
  ...
  public final native JsAny getBufferParameter(int target, int pname) /*-{
    return { data: this.getBufferParameter(target, pname) };
  }-*/;
  ...
  public final native JsAny getFramebufferAttachmentParameter(int target, int attachment, int pname) /*-{
    return { data: this.getFramebufferAttachmentParameter(target, attachment, pname) };
  }-*/;

  public final native JsAny getParameter(int pname) /*-{
    return { data: this.getParameter(pname)};
  }-*/;
  ...
  public final native JsAny getProgramParameter(WebGLProgram program, int pname) /*-{
    return { data: this.getProgramParameter(program, pname) };
  }-*/;

  public final native JsAny getRenderbufferParameter(int target, int pname) /*-{
    return { data: this.getRenderbufferParameter(target, pname) };
  }-*/;
  ...
  public final native JsAny getShaderParameter(WebGLShader shader, int pname) /*-{
    return { data: this.getShaderParameter(shader, pname) };
  }-*/;
  ...
  public final native JsAny getTexParameter(int target, int pname) /*-{
    return { data: this.getTexParameter(target, pname) };
  }-*/;

  public final native JsAny getUniform(WebGLProgram program, WebGLUniformLocation location) /*-{
    return { data: this.getUniform(program, location) };
  }-*/;
  ...
  public final native JsAny getVertexAttrib(int index, int pname) /*-{
    return { data: this.getVertexAttrib(index, pname) };
  }-*/;
