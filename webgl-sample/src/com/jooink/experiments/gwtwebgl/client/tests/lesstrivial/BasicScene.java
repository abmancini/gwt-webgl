...
public class BasicScene extends Scene {
	...
	public BasicScene(WebGLRenderingContext ctx3d, VideoElement theVideo, int w, int h) {
		super(ctx3d);
		this.videoElement = theVideo;
	...
	public void draw() {
		...
		ctx3d.texImage2D(WebGLRenderingContext.TEXTURE_2D, 0, WebGLRenderingContext.RGBA, WebGLRenderingContext.RGBA, WebGLRenderingContext.UNSIGNED_BYTE, videoElement);
